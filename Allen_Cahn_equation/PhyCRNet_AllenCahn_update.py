...
def compute_loss(output, u0, all_img, loss_func):
    ...
    return f, f_phy*10, f_bc/10, f_ic*10, f_data
...
if __name__ == '__main__':
    ...
    data = pd.read_csv('./Data/allen_cahn_flux0.1_100%.csv', skiprows=0)  # read comsol generated data
    ...
    # get all image
    all_imgs = []
    data_sample = pd.read_csv('./Data/allen_cahn_flux0.1_100%.csv', skiprows=0)  # read comsol generated data
    ...
    model_save_path =  './Allen_Cahn_equation/phycrnet_allencahn_5e-4.pt' # '/home/gli12/project/PhyCRNet/phyCRNet_AM/checkpoint_heat.pt'
