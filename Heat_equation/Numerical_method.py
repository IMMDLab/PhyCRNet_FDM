"This code uses the finite difference method to solve the heat equation in 2D."
"The boundary condition is flux boundary condition."
...
for n in range(Nt):
    for i in range(1, Nx - 1):
        for j in range(1, Ny - 1):
            ...
            u_new[i, j] = u[i, j] + dt * alpha * (uxx + uyy)
